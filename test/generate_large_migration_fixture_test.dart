...
void main() {
  test('generates a large migration fixture', () async {
    const count = 1000;
...
''');
    ...
    final imported = await MigrationPackageService().importNotes(
      packageText: await packageFile.readAsString(),
      passphrase: passphrase,
    );
    expect(imported, hasLength(count));
